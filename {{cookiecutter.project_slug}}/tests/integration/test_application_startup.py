...
from {{cookiecutter.package_name}}.runtime.settings import Settings, settings as config
...
class TestApplicationStartup:
    ...
    async def test_startup_initializes_rate_limiter_with_redis(self, monkeypatch):
        ...
        import {{cookiecutter.package_name}}.api.http.app as application
    ...
    async def test_startup_fails_when_dependencies_missing_in_production(self, monkeypatch):
        ...
        try:
            ...
            monkeypatch.setattr("{{cookiecutter.package_name}}.core.services.jwt_service.fetch_jwks", fake_fetch_jwks)
