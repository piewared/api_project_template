...
# Create ConfigMaps
kubectl apply -f k8s/base/configmaps/env-config.yaml
kubectl apply -f k8s/base/configmaps/app-env.yaml
kubectl apply -f k8s/base/configmaps/app-config.yaml
kubectl apply -f k8s/base/configmaps/postgres-config.yaml
kubectl apply -f k8s/base/configmaps/postgres-verifier-config.yaml
kubectl apply -f k8s/base/configmaps/temporal-config.yaml
