...
from {{cookiecutter.package_name}}.api.http.deps import get_current_user, require_role, require_scope
from {{cookiecutter.package_name}}.api.http.middleware.limiter import close_rate_limiter, configure_rate_limiter
from {{cookiecutter.package_name}}.core.entities.user import User as UserEntity
...
def _activate_local_rate_limiter() -> None:
    ...
    if limiter is None:
        from {{cookiecutter.package_name}}.api.http.middleware.limiter import DefaultLocalRateLimiter
