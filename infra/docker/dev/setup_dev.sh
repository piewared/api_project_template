...
echo "  PostgreSQL: localhost:5432 (appuser/devpass)"
echo ""
echo "Databases:"
echo "  Development: postgresql://appuser:devpass@localhost:5432/appdb"
echo "  Test: postgresql://appuser:devpass@localhost:5432/testdb"
echo ""
