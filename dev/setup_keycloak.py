...
class KeycloakSetup:
    ...
    def get_admin_token(self):
        ...
        token_url = urljoin(self.base_url, "/realms/master/protocol/openid-connect/token")
    ...
    def create_client(self, realm_name="test-realm", client_id="test-client"):
        ...
        check_response = requests.get(url, headers=headers, params={"clientId": client_id})
        ...
        if response.status_code == 201:
            ...
            clients_response = requests.get(url, headers=headers, params={"clientId": client_id})
    ...
    def set_client_secret(self, realm_name, client_uuid, secret):
        """Set client secret."""
        url = urljoin(self.base_url, f"/admin/realms/{realm_name}/clients/{client_uuid}")
    ...
    def print_configuration(self, realm_name="test-realm", client_id="test-client"):
        ...
        print(f"Authorization Endpoint: {self.base_url}/realms/{realm_name}/protocol/openid-connect/auth")
        print(f"Token Endpoint: {self.base_url}/realms/{realm_name}/protocol/openid-connect/token")
        print(f"Userinfo Endpoint: {self.base_url}/realms/{realm_name}/protocol/openid-connect/userinfo")
        print(f"JWKS URI: {self.base_url}/realms/{realm_name}/protocol/openid-connect/certs")
        print(f"End Session Endpoint: {self.base_url}/realms/{realm_name}/protocol/openid-connect/logout")
        print("")
        ...
        print(f"OIDC_DEFAULT_AUTHORIZATION_ENDPOINT={self.base_url}/realms/{realm_name}/protocol/openid-connect/auth")
        print(f"OIDC_DEFAULT_TOKEN_ENDPOINT={self.base_url}/realms/{realm_name}/protocol/openid-connect/token")
        print(f"OIDC_DEFAULT_USERINFO_ENDPOINT={self.base_url}/realms/{realm_name}/protocol/openid-connect/userinfo")
        print(f"OIDC_DEFAULT_JWKS_URI={self.base_url}/realms/{realm_name}/protocol/openid-connect/certs")
        print(f"OIDC_DEFAULT_END_SESSION_ENDPOINT={self.base_url}/realms/{realm_name}/protocol/openid-connect/logout")
